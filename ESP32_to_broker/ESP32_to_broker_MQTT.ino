...
int publishDelay = 10 * 1000;       /* Delay time after publishing sensor data (10 sec)*/
...
void deepSleep() {
  ...
  esp_sleep_enable_timer_wakeup(TIME_TO_SLEEP * uS_TO_S_FACTOR); //time in microseconds
  ...
  Serial.println("This will never be printed cause ESP is sleeping");
